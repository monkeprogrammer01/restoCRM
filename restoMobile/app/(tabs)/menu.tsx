...
export default function Menu() {
  ...
  const categories = [
    { id: 'all', name: 'Все', icon: 'apps', iconLib: 'Ionicons' },
    { id: 'hot', name: 'Горячее', icon: 'flame', iconLib: 'Ionicons' },
    { id: 'salads', name: 'Салаты', icon: 'leaf', iconLib: 'Ionicons' },
    { id: 'desserts', name: 'Десерты', icon: 'ice-cream', iconLib: 'Ionicons' },
    { id: 'drinks', name: 'Напитки', icon: 'cafe', iconLib: 'Ionicons' },
  ];
  ...
  const dishes: Dish[] = [
    ...
    },
    {
      ...
      category: 'Салаты',
      rating: 4.6,
      description: 'Свежий салат с пармезаном и сухариками',
      calories: 350,
      prepTime: '10-15 мин',
    },
    {
